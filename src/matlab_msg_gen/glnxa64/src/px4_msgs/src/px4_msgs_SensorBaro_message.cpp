...
// Common copy functions for px4_msgs/SensorBaro
#ifdef _MSC_VER
#pragma warning(push)
...
class PX4_MSGS_EXPORT ros2_px4_msgs_msg_SensorBaro_common : public MATLABROS2MsgInterface<px4_msgs::msg::SensorBaro> {
  public:
    virtual ~ros2_px4_msgs_msg_SensorBaro_common(){}
    virtual void copy_from_struct(px4_msgs::msg::SensorBaro* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const px4_msgs::msg::SensorBaro* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_px4_msgs_msg_SensorBaro_common::copy_from_struct(px4_msgs::msg::SensorBaro* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_px4_msgs_msg_SensorBaro_common::get_arr(MDFactory_T& factory, const px4_msgs::msg::SensorBaro* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","timestamp","timestamp_sample","device_id","pressure","temperature","error_count","ORB_QUEUE_LENGTH"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("px4_msgs/SensorBaro");
    // timestamp
...
class PX4_MSGS_EXPORT ros2_px4_msgs_SensorBaro_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_px4_msgs_SensorBaro_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_px4_msgs_SensorBaro_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<px4_msgs::msg::SensorBaro,ros2_px4_msgs_msg_SensorBaro_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_px4_msgs_SensorBaro_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<px4_msgs::msg::SensorBaro,ros2_px4_msgs_msg_SensorBaro_common>>();
  }
  std::shared_ptr<void> ros2_px4_msgs_SensorBaro_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<px4_msgs::msg::SensorBaro>();
    ros2_px4_msgs_msg_SensorBaro_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_px4_msgs_SensorBaro_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_px4_msgs_msg_SensorBaro_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (px4_msgs::msg::SensorBaro*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_msg_SensorBaro_common, MATLABROS2MsgInterface<px4_msgs::msg::SensorBaro>)
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_SensorBaro_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
