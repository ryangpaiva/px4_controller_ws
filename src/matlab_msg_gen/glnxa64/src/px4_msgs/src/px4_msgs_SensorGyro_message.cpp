...
// Common copy functions for px4_msgs/SensorGyro
#ifdef _MSC_VER
#pragma warning(push)
...
class PX4_MSGS_EXPORT ros2_px4_msgs_msg_SensorGyro_common : public MATLABROS2MsgInterface<px4_msgs::msg::SensorGyro> {
  public:
    virtual ~ros2_px4_msgs_msg_SensorGyro_common(){}
    virtual void copy_from_struct(px4_msgs::msg::SensorGyro* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const px4_msgs::msg::SensorGyro* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_px4_msgs_msg_SensorGyro_common::copy_from_struct(px4_msgs::msg::SensorGyro* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_px4_msgs_msg_SensorGyro_common::get_arr(MDFactory_T& factory, const px4_msgs::msg::SensorGyro* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("px4_msgs/SensorGyro");
    // timestamp
    ...
    outArray[ctr]["clip_counter"] = factory.createArray<px4_msgs::msg::SensorGyro::_clip_counter_type::const_iterator, uint8_t>({currentElement_clip_counter.size(), 1}, currentElement_clip_counter.begin(), currentElement_clip_counter.end());
    // samples
...
class PX4_MSGS_EXPORT ros2_px4_msgs_SensorGyro_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_px4_msgs_SensorGyro_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_px4_msgs_SensorGyro_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<px4_msgs::msg::SensorGyro,ros2_px4_msgs_msg_SensorGyro_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_px4_msgs_SensorGyro_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<px4_msgs::msg::SensorGyro,ros2_px4_msgs_msg_SensorGyro_common>>();
  }
  std::shared_ptr<void> ros2_px4_msgs_SensorGyro_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<px4_msgs::msg::SensorGyro>();
    ros2_px4_msgs_msg_SensorGyro_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_px4_msgs_SensorGyro_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_px4_msgs_msg_SensorGyro_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (px4_msgs::msg::SensorGyro*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_msg_SensorGyro_common, MATLABROS2MsgInterface<px4_msgs::msg::SensorGyro>)
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_SensorGyro_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
