...
// Common copy functions for px4_msgs/RoverDifferentialSetpoint
#ifdef _MSC_VER
#pragma warning(push)
...
#include "px4_msgs/msg/rover_differential_setpoint.hpp"
#include "visibility_control.h"
#include "class_loader/multi_library_class_loader.hpp"
#include "ROS2PubSubTemplates.hpp"
class PX4_MSGS_EXPORT ros2_px4_msgs_msg_RoverDifferentialSetpoint_common : public MATLABROS2MsgInterface<px4_msgs::msg::RoverDifferentialSetpoint> {
  public:
    virtual ~ros2_px4_msgs_msg_RoverDifferentialSetpoint_common(){}
    virtual void copy_from_struct(px4_msgs::msg::RoverDifferentialSetpoint* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const px4_msgs::msg::RoverDifferentialSetpoint* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_px4_msgs_msg_RoverDifferentialSetpoint_common::copy_from_struct(px4_msgs::msg::RoverDifferentialSetpoint* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_px4_msgs_msg_RoverDifferentialSetpoint_common::get_arr(MDFactory_T& factory, const px4_msgs::msg::RoverDifferentialSetpoint* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","timestamp","forward_speed_setpoint","forward_speed_setpoint_normalized","yaw_rate_setpoint","speed_diff_setpoint_normalized","yaw_setpoint"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("px4_msgs/RoverDifferentialSetpoint");
    // timestamp
...
class PX4_MSGS_EXPORT ros2_px4_msgs_RoverDifferentialSetpoint_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_px4_msgs_RoverDifferentialSetpoint_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_px4_msgs_RoverDifferentialSetpoint_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<px4_msgs::msg::RoverDifferentialSetpoint,ros2_px4_msgs_msg_RoverDifferentialSetpoint_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_px4_msgs_RoverDifferentialSetpoint_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<px4_msgs::msg::RoverDifferentialSetpoint,ros2_px4_msgs_msg_RoverDifferentialSetpoint_common>>();
  }
  std::shared_ptr<void> ros2_px4_msgs_RoverDifferentialSetpoint_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<px4_msgs::msg::RoverDifferentialSetpoint>();
    ros2_px4_msgs_msg_RoverDifferentialSetpoint_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_px4_msgs_RoverDifferentialSetpoint_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_px4_msgs_msg_RoverDifferentialSetpoint_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (px4_msgs::msg::RoverDifferentialSetpoint*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_msg_RoverDifferentialSetpoint_common, MATLABROS2MsgInterface<px4_msgs::msg::RoverDifferentialSetpoint>)
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_RoverDifferentialSetpoint_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
