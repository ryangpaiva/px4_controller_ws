...
// Common copy functions for px4_msgs/SensorAccel
#ifdef _MSC_VER
#pragma warning(push)
...
class PX4_MSGS_EXPORT ros2_px4_msgs_msg_SensorAccel_common : public MATLABROS2MsgInterface<px4_msgs::msg::SensorAccel> {
  public:
    virtual ~ros2_px4_msgs_msg_SensorAccel_common(){}
    virtual void copy_from_struct(px4_msgs::msg::SensorAccel* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const px4_msgs::msg::SensorAccel* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_px4_msgs_msg_SensorAccel_common::copy_from_struct(px4_msgs::msg::SensorAccel* msg, const matlab::data::Struct& arr,
    ...
    try {
        //clip_counter
        const matlab::data::TypedArray<uint8_t> clip_counter_arr = arr["clip_counter"];
        size_t nelem = 3;
        	std::copy(clip_counter_arr.begin(), clip_counter_arr.begin()+nelem, msg->clip_counter.begin());
    } catch (matlab::data::InvalidFieldNameException&) {
        throw std::invalid_argument("Field 'clip_counter' is missing.");
    } catch (matlab::Exception&) {
        throw std::invalid_argument("Field 'clip_counter' is wrong type; expected a uint8.");
    }
    try {
        //samples
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_px4_msgs_msg_SensorAccel_common::get_arr(MDFactory_T& factory, const px4_msgs::msg::SensorAccel* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","timestamp","timestamp_sample","device_id","x","y","z","temperature","error_count","clip_counter","samples","ORB_QUEUE_LENGTH"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("px4_msgs/SensorAccel");
    // timestamp
    ...
    // clip_counter
    auto currentElement_clip_counter = (msg + ctr)->clip_counter;
    outArray[ctr]["clip_counter"] = factory.createArray<px4_msgs::msg::SensorAccel::_clip_counter_type::const_iterator, uint8_t>({currentElement_clip_counter.size(), 1}, currentElement_clip_counter.begin(), currentElement_clip_counter.end());
    // samples
...
class PX4_MSGS_EXPORT ros2_px4_msgs_SensorAccel_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_px4_msgs_SensorAccel_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_px4_msgs_SensorAccel_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<px4_msgs::msg::SensorAccel,ros2_px4_msgs_msg_SensorAccel_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_px4_msgs_SensorAccel_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<px4_msgs::msg::SensorAccel,ros2_px4_msgs_msg_SensorAccel_common>>();
  }
  std::shared_ptr<void> ros2_px4_msgs_SensorAccel_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<px4_msgs::msg::SensorAccel>();
    ros2_px4_msgs_msg_SensorAccel_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_px4_msgs_SensorAccel_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_px4_msgs_msg_SensorAccel_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (px4_msgs::msg::SensorAccel*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_msg_SensorAccel_common, MATLABROS2MsgInterface<px4_msgs::msg::SensorAccel>)
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_SensorAccel_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
