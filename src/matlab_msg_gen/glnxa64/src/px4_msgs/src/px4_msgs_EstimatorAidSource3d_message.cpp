...
// Common copy functions for px4_msgs/EstimatorAidSource3d
#ifdef _MSC_VER
#pragma warning(push)
...
class PX4_MSGS_EXPORT ros2_px4_msgs_msg_EstimatorAidSource3d_common : public MATLABROS2MsgInterface<px4_msgs::msg::EstimatorAidSource3d> {
  public:
    virtual ~ros2_px4_msgs_msg_EstimatorAidSource3d_common(){}
    virtual void copy_from_struct(px4_msgs::msg::EstimatorAidSource3d* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const px4_msgs::msg::EstimatorAidSource3d* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_px4_msgs_msg_EstimatorAidSource3d_common::copy_from_struct(px4_msgs::msg::EstimatorAidSource3d* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_px4_msgs_msg_EstimatorAidSource3d_common::get_arr(MDFactory_T& factory, const px4_msgs::msg::EstimatorAidSource3d* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("px4_msgs/EstimatorAidSource3d");
    // timestamp
    ...
    outArray[ctr]["observation"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_observation_type::const_iterator, float>({currentElement_observation.size(), 1}, currentElement_observation.begin(), currentElement_observation.end());
    // observation_variance
    auto currentElement_observation_variance = (msg + ctr)->observation_variance;
    outArray[ctr]["observation_variance"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_observation_variance_type::const_iterator, float>({currentElement_observation_variance.size(), 1}, currentElement_observation_variance.begin(), currentElement_observation_variance.end());
    // innovation
    auto currentElement_innovation = (msg + ctr)->innovation;
    outArray[ctr]["innovation"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_innovation_type::const_iterator, float>({currentElement_innovation.size(), 1}, currentElement_innovation.begin(), currentElement_innovation.end());
    // innovation_filtered
    auto currentElement_innovation_filtered = (msg + ctr)->innovation_filtered;
    outArray[ctr]["innovation_filtered"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_innovation_filtered_type::const_iterator, float>({currentElement_innovation_filtered.size(), 1}, currentElement_innovation_filtered.begin(), currentElement_innovation_filtered.end());
    // innovation_variance
    auto currentElement_innovation_variance = (msg + ctr)->innovation_variance;
    outArray[ctr]["innovation_variance"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_innovation_variance_type::const_iterator, float>({currentElement_innovation_variance.size(), 1}, currentElement_innovation_variance.begin(), currentElement_innovation_variance.end());
    // test_ratio
    auto currentElement_test_ratio = (msg + ctr)->test_ratio;
    outArray[ctr]["test_ratio"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_test_ratio_type::const_iterator, float>({currentElement_test_ratio.size(), 1}, currentElement_test_ratio.begin(), currentElement_test_ratio.end());
    // test_ratio_filtered
    auto currentElement_test_ratio_filtered = (msg + ctr)->test_ratio_filtered;
    outArray[ctr]["test_ratio_filtered"] = factory.createArray<px4_msgs::msg::EstimatorAidSource3d::_test_ratio_filtered_type::const_iterator, float>({currentElement_test_ratio_filtered.size(), 1}, currentElement_test_ratio_filtered.begin(), currentElement_test_ratio_filtered.end());
    // innovation_rejected
...
class PX4_MSGS_EXPORT ros2_px4_msgs_EstimatorAidSource3d_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_px4_msgs_EstimatorAidSource3d_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_px4_msgs_EstimatorAidSource3d_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<px4_msgs::msg::EstimatorAidSource3d,ros2_px4_msgs_msg_EstimatorAidSource3d_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_px4_msgs_EstimatorAidSource3d_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<px4_msgs::msg::EstimatorAidSource3d,ros2_px4_msgs_msg_EstimatorAidSource3d_common>>();
  }
  std::shared_ptr<void> ros2_px4_msgs_EstimatorAidSource3d_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<px4_msgs::msg::EstimatorAidSource3d>();
    ros2_px4_msgs_msg_EstimatorAidSource3d_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_px4_msgs_EstimatorAidSource3d_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_px4_msgs_msg_EstimatorAidSource3d_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (px4_msgs::msg::EstimatorAidSource3d*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_msg_EstimatorAidSource3d_common, MATLABROS2MsgInterface<px4_msgs::msg::EstimatorAidSource3d>)
CLASS_LOADER_REGISTER_CLASS(ros2_px4_msgs_EstimatorAidSource3d_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
