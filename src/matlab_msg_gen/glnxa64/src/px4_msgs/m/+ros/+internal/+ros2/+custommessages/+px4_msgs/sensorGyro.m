function [data, info] = sensorGyro
%SensorGyro gives an empty data for px4_msgs/SensorGyro
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'px4_msgs/SensorGyro';
...
info.MessageType = 'px4_msgs/SensorGyro';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
