function [data, info] = sensorAccel
%SensorAccel gives an empty data for px4_msgs/SensorAccel
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'px4_msgs/SensorAccel';
...
[data.clip_counter, info.clip_counter] = ros.internal.ros2.messages.ros2.default_type('uint8',3,0);
...
info.MessageType = 'px4_msgs/SensorAccel';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
...
info.MatPath{9} = 'clip_counter';
info.MatPath{10} = 'samples';
info.MatPath{11} = 'ORB_QUEUE_LENGTH';
