function [data, info] = vehicleAcceleration
%VehicleAcceleration gives an empty data for px4_msgs/VehicleAcceleration
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'px4_msgs/VehicleAcceleration';
...
info.MessageType = 'px4_msgs/VehicleAcceleration';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
