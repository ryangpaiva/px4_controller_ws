...
bool cdr_serialize_px4_msgs__msg__RoverAckermannStatus(
  const px4_msgs__msg__RoverAckermannStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_deserialize_px4_msgs__msg__RoverAckermannStatus(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs__msg__RoverAckermannStatus * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_serialize_key_px4_msgs__msg__RoverAckermannStatus(
  const px4_msgs__msg__RoverAckermannStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t get_serialized_size_key_px4_msgs__msg__RoverAckermannStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RoverAckermannStatus__ros_msg_type * ros_message = static_cast<const _RoverAckermannStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_key_px4_msgs__msg__RoverAckermannStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4_msgs__msg__RoverAckermannStatus * ros_message = static_cast<const px4_msgs__msg__RoverAckermannStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4_msgs__msg__RoverAckermannStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4_msgs__msg__RoverAckermannStatus * ros_message = static_cast<px4_msgs__msg__RoverAckermannStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4_msgs__msg__RoverAckermannStatus(cdr, ros_message);
}
